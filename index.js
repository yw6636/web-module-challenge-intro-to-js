...
let firstThing = 'Greet'
let secondThing = 'Handshake'
if(secondThing = 'Handshake'){
  firstThing = 'Smile';
}else{
  firstThing = 'Greet';
}
...
console.log('task 1 d:', multiply(7,8));
...
hungryDog('task 3', hungryDog(15,1));
